        ...
        try:
            ...
            if temp_emails:
                ...
                try:
                    ...
                    email_addresses3 = finds(next_url)
                    ...
                    driver = webdriver.Edge(executable_path=paths, options=options,service=service)
                    driver.get(next_url)
                    time.sleep(3)
                    html = driver.page_source
                    email_addresses2 = extract_email_addresses(html)[0]
                    temp_emails[url] = email_addresses2
                    print(email_addresses2)
                    driver.close()
                finally:
                    emails.update(temp_emails)
        except:
